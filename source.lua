--[[
	...
	Rayfield Interface Suite - Intelfield
	by Sirius
	...
	!! Made small modifications for the built in notifications to be less disturbing
...
local RayfieldFolder = "Intelfield"
local ConfigurationFolder = RayfieldFolder.."/Configurations"
local ConfigurationExtension = ".ifld"
local settingsTable = {
	General = {
